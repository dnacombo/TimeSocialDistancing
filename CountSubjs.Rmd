...
params:
  ...
  ExperimentID: null
  Session: null    
  rootdir: '/home/maximilien.chaumon/ownCloud/Lab/00-Projects/TimeSocialDistancing/DATA/data_exp_210125'
output:
  html_notebook:
    code_folding: hide
    df_print: paged
...
```{r}
d <- gimmedata(DataDir = params$rootdir, ExperimentName = paste(l$ExperimentName,collapse='|'), verbose = F) %>%
