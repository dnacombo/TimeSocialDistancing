...
RetroDuration_PoT <- gimmeRdata(params$datadir, UniqueName = 'RetroDuration') %>%
...
save(RetroDuration_PoT, file = file.path(params$datadir,'RetroDuration_PoT.RData'))

load(file = file.path(params$datadir,'RetroDuration_PoT.RData'))
```
...
save(RetroDuration_PoT_clean, file = file.path(params$datadir,'RetroDuration_PoT_clean.RData'))
...
```{r}
load(file = file.path(params$datadir,'RetroDuration_PoT_clean.RData'))
