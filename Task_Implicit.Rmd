...
# recombine all parameters
l <- paramsMatch(Country = params$Country,
...
```{r, rows.print = 100}
  ...
  orig <- gimmedata(l$datadir, ExperimentID = paste(l$ExperimentID,sep='|'), UniqueName = 'Implicit', verbose = F, progress = F) %>%
...
ggplot(durations,aes(x=Duration)) +
