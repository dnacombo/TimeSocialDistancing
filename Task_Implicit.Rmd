...
orig <- gimmedata(params$datadir, ExperimentName = params$ExperimentName, UniqueName = 'Implicit', verbose = F) %>%
...
```{r}
# data_all_exp <- gimmedata(params$datadir, UniqueName = 'Implicit', verbose = F) %>%
