...
Removing outliers shown in previous plot from the data
```{r}
m <- lm(log10(EstimatedDuration) ~ log10(ClockDuration) * Session, data = ungroup(tostat) %>% slice(-129, -1607, -1061, -97, -308, -1539))
...
imagefile = '/home/maximilien.chaumon/ownCloud/Lab/00-Projects/TimeSocialDistancing/PaperFigures/fig1a.png'
ggsave(
  basename(imagefile),
  plot = last_plot(),
  device = 'png',
...
imagefile = '/home/maximilien.chaumon/ownCloud/Lab/00-Projects/TimeSocialDistancing/PaperFigures/fig1b.png'
ggsave(
  basename(imagefile),
  plot = last_plot(),
  device = 'png',
...
imagefile = '/home/maximilien.chaumon/ownCloud/Lab/00-Projects/TimeSocialDistancing/PaperFigures/fig1c.png'
ggsave(
  basename(imagefile),
  plot = last_plot(),
  device = 'png',
...
```{r}
m <- lm(log10(rEstimatedDuration) ~ Stringency_Index + Mobility_Transit + Mobility_Retail + Mobility_Parks + Mobility_WorkPlaces + Mobility_Residential + Subjective_Confinement + Age + poly(Hour_Of_Day,3), data = ungroup(tostat) %>% slice(-2236, -1706, -1618, -2233, -129, -694, -2230, -616, -1341))
...
imagefile = '/home/maximilien.chaumon/ownCloud/Lab/00-Projects/TimeSocialDistancing/PaperFigures/Fig1.pdf'
ggsave(
  basename(imagefile),
  plot = last_plot(),
  device = 'pdf',
